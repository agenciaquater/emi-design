            ...
            <main>
                <div className={styles.contactInfo}>
                    ...
                    <div className={styles.links}>
                        ...
                        <a
                          href="https://api.whatsapp.com/send?phone=5551999637844&text=Ol%C3%A1!%20Gostaria%20de%20mais%20informa%C3%A7%C3%B5es%20sobre%20o%20condom%C3%ADnio%20residencial%20Design!"
                          target="_blank">
                ...
                <div className={styles.logo}>
                    <p>EDIFÍCIO</p>
                    <img src="/images/design-logo-white.webp" alt="promenade" />
