    ...
    return (
        <header className={styles.container}>
            <div className={styles.content}>
                ...
                <a href="https://api.whatsapp.com/send?phone=5551999637844&text=Ol%C3%A1!%20Gostaria%20de%20mais%20informa%C3%A7%C3%B5es%20sobre%20o%20condom%C3%ADnio%20residencial%20Design!">
